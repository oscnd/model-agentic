...
// FormatContentArguments represents arguments for format content function
type FormatContentArguments struct {
...
func main() {
	...
	formatContentDeclaration := function.NewDeclaration(
		gut.Ptr("format_content"),
		gut.Ptr("Format content into a structured document"),
		func(arguments *FormatContentArguments) (map[string]any, *gut.ErrorInstance) {
			var formattedContent string
			switch arguments.Format {
			case "markdown":
				formattedContent = "# Research Summary\n\n" + arguments.Content + "\n\n---\n\n*Generated by AI Agent*"
			case "bullet":
				lines := strings.Split(arguments.Content, ". ")
			...
			default:
				formattedContent = arguments.Content
			}
